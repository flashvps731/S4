...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @TG_FLASH92"
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @TG_,FLASH92"
    bot.reply_to(message, response)
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @TG_FLASH92"
...
𝘽𝙪𝙮 :- @TG_FLASH92
𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 :- https://t.me/+EMIeD5VKxiYwY2U1
'''
...
𝙑𝙞𝙥 🌟 :
-> 𝘼𝙩𝙩𝙖𝙘𝙠 𝙏𝙞𝙢𝙚 : 120 (𝙎)
> 𝘼𝙛𝙩𝙚𝙧 𝘼𝙩𝙩𝙖𝙘𝙠 𝙇𝙞𝙢𝙞𝙩 : 1 𝙨𝙚𝙘
-> 𝘾𝙤𝙣𝙘𝙪𝙧𝙧𝙚𝙣𝙩𝙨 𝘼𝙩𝙩𝙖𝙘𝙠 : 5
